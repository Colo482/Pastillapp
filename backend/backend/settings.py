...
SECRET_KEY = 'django-insecure-=ue81yfrf*vu$btx9*zhqn*5nt26%6%wx7-s3a#4^5p2o*(wyi'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['*']  # Desplegando en Render
...
MIDDLEWARE = [
    'corsheaders.middleware.CorsMiddleware', # 2. Agregamos el middleware ARRIBA de todo
